...
/* user/new.html.twig */
class __TwigTemplate_905eac1823471d2968cff7c477624fe6bcfc5cdeceb4c89a3746cbb12ac110ae extends Twig_Template
{
    private $source;
...
{% block body %}
    ...
    <ul>
        <li>
            <a href=\"{{ path('app_user_list') }}\">Back to the list</a>
        </li>
    </ul>
{% endblock %}
", "user/new.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/xintegro/app/Resources/views/user/new.html.twig");
    }
}

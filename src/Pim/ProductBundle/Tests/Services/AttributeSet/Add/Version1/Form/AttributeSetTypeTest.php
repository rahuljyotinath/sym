...
namespace Pim\ProductBundle\Tests\Services\AttributeSet\Add\Version1\Form;

use Pim\ProductBundle\Services\AttributeSet\Add\Version1\Form\AttributeSetType;
...
class AttributeSetTypeTest extends TypeTestCase
{
    public function testSubmitValidData()
    {
        ...
        $form = $this->factory->create(AttributeSetType::class);

...
namespace Pim\ProductBundle\Tests\Services\AttributeSet\Add;

use PHPUnit\Framework\TestCase;
use AppBundle\Rest\Api\Manager as ApiManager;
use Pim\ProductBundle\Database\Manager as DbM;
use Pim\ProductBundle\Services\AttributeSet\Add\Factory;
use Pim\ProductBundle\Services\AttributeSet\Add\Version1\Handler as Version1Handler;

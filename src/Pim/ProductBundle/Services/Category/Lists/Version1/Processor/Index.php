...
namespace Pim\ProductBundle\Services\Category\Lists\Version1\Processor;

use AppBundle\Rest\Api\Manager as ApiManager;
use Pim\ProductBundle\Database\Manager as DbM;
use Pim\ProductBundle\Services\Category\Lists\Version1\Request\Request as RequestModel;
use Pim\ProductBundle\Services\Category\Lists\Version1\Response\Response as ResponseModel;
use Pim\ProductBundle\Services\Category\Lists\Version1\Response\Product as SingleProductResponse;
use Pim\ProductBundle\Entity\Category as CategoryEntities;
use Pim\ProductBundle\Services\Common\Error;

/**
 * Class Index
 * @package Pim\ProductBundle\Services\Category\Lists\Version1\Processor
 */
class Index
{
    /**
    ...
    public function handleRequestModel(RequestModel $requestModel) : ResponseModel
    {
        try {
            ...
            $this->mapProductToResponse($this->dbM->repository()->product()->findBy([],[$orderBy => $orderDir], $limit, $offset));

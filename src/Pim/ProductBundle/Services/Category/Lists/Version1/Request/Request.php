...
namespace Pim\ProductBundle\Services\Category\Lists\Version1\Request;

use Symfony\Component\Validator\Constraints as Assert;

/**
 * Class Request
 * @package Pim\ProductBundle\Services\Category\Lists\Version1\Request
 */
class Request
{
    /**
     ...
     * @var string
     *
     * @Assert\Regex("(^sku$|^title$|^created$|^updated$)")
     */
    private $orderBy;

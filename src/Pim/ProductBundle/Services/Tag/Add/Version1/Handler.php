...
namespace Pim\ProductBundle\Services\Tag\Add\Version1;
...
/**
 * Class Handler
 * @package Pim\ProductBundle\Services\Tag\Add\Version1
 */
    ...
    private function validateRequest(Request $request)
    {
        ...
        if (count($validationErrors) > 0) {
            foreach ($validationErrors as $error) {
                $errorHit = $this->errorManager->error()->setCode(400)->setMessage($error->getPropertyPath() . ": " . $error->getMessage());
                $this->errorResponse->setCode(400);
                $this->errorResponse->addError($errorHit);
            }
        }
    }

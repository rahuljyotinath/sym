...
namespace Pim\ProductBundle\Services\Product\Add\Version1\Processor;
...
use Pim\ProductBundle\Entity\Product as ProductEntity;
use Pim\ProductBundle\Services\Common\Error;

/**
 * Class Index
 * @package Pim\ProductBundle\Services\Product\Add\Version1\Processor
 */
class Index
{
    /**
    ...
    private function mapRequestToEntity(RequestModel $requestModel) : ProductEntity
    {
        ...
        if(null !== $requestModel->getAttributes()){

...
namespace Pim\ProductBundle\Services\AttributeSet\Update\Version1\Processor;
...
/**
 * Class Index
 * @package Pim\ProductBundle\Services\AttributeSet\Update\Version1\Processor
 */
class Index
{
    /**
    ...
    {
        try {
            $this->attributeSetEntity = $this->dbM->repository()->attributeSet()->find($requestModel->getUuid());
            if(null === $this->attributeSetEntity){
                ...
                $this->dbM->entityManager()->flush($this->attributeSetEntity);
    ...
    {
        $this->attributeSetEntity->setName($requestModel->getName());
        $this->attributeSetEntity->setAttributes($requestModel->getAttributes());
    ...
    private function setSuccessResponse()
    {
        ...
        $this->responseModel->setMessage('AttributeSet updated!');
    }
}

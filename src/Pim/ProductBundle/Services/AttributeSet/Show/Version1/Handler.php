...
namespace Pim\ProductBundle\Services\AttributeSet\Show\Version1;
...
/**
 * Class Handler
 * @package Pim\ProductBundle\Services\AttributeSet\Show\Version1
 */
class Handler implements HandlerInterface
{
    ...
    private function validateRequest(Request $request)
    {
        ...
        $this->requestModel->setUuid($request->get('uuid', ''));
